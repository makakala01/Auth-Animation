...
import { Text, View, Dimensions, TextInput, StyleSheet, Pressable } from 'react-native';
...
export default function App() {
  ...
  const loginHandler = () => {
    ...
    if (isRegistering) {
      ...
      // incase you are using gesturehandler
  ...
  return (
    <Animated.View style={styles.container}>
      ...
      <View style={styles.bottomContainer}>
        ...
        <Animated.View style={[styles.formInputConatiner, formAnimatedStyle]}>
